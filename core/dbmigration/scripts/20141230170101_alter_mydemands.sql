DROP TABLE IF EXISTS `mydemands`/
...
CREATE TABLE `mydemands` (
  ...
  `deliverydate` date DEFAULT NULL COMMENT '提货日期',
  `deliverydatestart` date DEFAULT NULL COMMENT '自提提货时间开始',
  `deliverydateend` date DEFAULT NULL COMMENT '自提提货时间截至',
  PRIMARY KEY (`id`)
