    ...
    <div class="container paddingSpace">
        ...
        <div style="margin: 0px auto; width: 100%; height: 110px;float: left;background-color: #eeeeee;text-align: center;line-height: 55px;">
            ...
            <div id="buyDiv">
                ...
                <#if RS01!='0'>
                    <input type="text" data-placement="bottom" data-content="0< x <10" data-trigger="manual" class="inputStyle" value="${RS01!''}" id="smallRS"  style="ime-mode:disabled" maxlength="4" onkeydown="if(event.keyCode==13)event.keyCode=9" onkeypress="return filterRS(event);"/>
                <#else>
                    <input type="text" data-placement="bottom" data-content="0< x <10" data-trigger="manual"  class="inputStyle" id="smallRS" style="ime-mode:disabled" maxlength="4" onkeydown="if(event.keyCode==13)event.keyCode=9" onkeypress="return filterRS(event);"/>
                </#if>
                <label  id="bet">至</label>
                <#if RS02!='10'>
                    <input type="text"  data-placement="bottom" data-content="0< x <10" data-trigger="manual" class="inputStyle" value="${RS02!''}" id="bigRS" style="ime-mode:disabled" maxlength="4" onkeydown="if(event.keyCode==13)event.keyCode=9" onkeypress="return filterRS(event);"/>
                <#else>
                    <input type="text" data-placement="bottom" data-content="0< x <10" data-trigger="manual"  class="inputStyle" id="bigRS" style="ime-mode:disabled" maxlength="4" onkeydown="if(event.keyCode==13)event.keyCode=9" onkeypress="return filterRS(event);"/>
                </#if>

                <button style="margin-left: 40px; margin-right: 10px; color:#ffffff; width: 120px; background-color:#317ee6";  class="btn" type="button" id="btn_search">搜索</button>
            </div>
        </div>
        </form>
        <div id="filter">
        ...
        <div class="market-main">
                    ...
                    <#if (parameterMap?size>0)>
                        ...
                        <tr onclick="openNewPage('${good.id?c}','${good.seller}');">
                            ...
                            <#if good.availquantity <= 0>
                                <td style="color: #ff0000;text-align: right;" class="a_btn">已售罄</td>
                            <#else>
                                <td style="color: #ff0000;text-align: right;" class="a_btn">${good.availquantity}</td>
                            </#if>
            ...
            <@pager path="/buy" params={"NCV01":NCV01,"NCV02":NCV02,"RS01":RS01,"RS02":RS02,"province":province,"harbour":harbour,"coaltype":coaltype,"sorttype":sorttype,"sequence":sequence} page=page pagesize=pagesize count=count class="pager"/>
        </div>
    </div>
</div>
