<@extend name="layout">
    ...
    <div class="clear-level">
        <div class="container">
            <div id="body-head">
                <div style="border-left:4px solid red;"><h5>&nbsp;&nbsp;发布供应信息</h5></div>
                <hr>
            </div>
            <div>
                <form class="form-horizontal" id="supply-form" action="/addSellinfo">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 col-md-6">
                            <div class="col-xs-7 col-md-7">
                                <#if sellInfo??>
                                    <input class="form-control" type="text" id="dwrz" name="NCV" value="${sellInfo.NCV?c!''}">
                                <#else>
                                    <input class="form-control" type="text" id="dwrz" name="NCV" placeholder="请输入3000-7000之间的值">
                                </#if>
                            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-6 col-md-6">
                        <div class="col-xs-7 col-md-7">
                            <#if sellInfo??>
                                <input class="form-control" type="text" id="originplace" name="originplace" value="${sellInfo.originplace!''}" maxlength="100">
                            <#else>
                                <input class="form-control" type="text" id="originplace" name="originplace" placeholder="请输入产地" maxlength="100">
                            </#if>
                        </div>
                        <div class="col-xs-5 col-md-5">
            ...
            <div class="form-group">
                        ...
                        <div class="col-xs-6 col-md-6">
                            <div class="col-xs-7 col-md-7">
                                <#if sellInfo??>
                                    <#if sellInfo.ADS != 0>
                                        <input class="form-control" type="text" name="ADS" id="ADS"  value="${sellInfo.ADS!''}">
                                    <#else>
                                        <input class="form-control" type="text" name="ADS"  id="ADS" placeholder="请输入0-10之间的值">
                                    </#if>
                                <#else>
                                    <input class="form-control" type="text" name="ADS" id="ADS" placeholder="请输入0-10之间的值">
                                </#if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 col-md-6">
                            <div class="col-xs-7 col-md-7">
                                <#if sellInfo??>
                                    <input class="form-control" type="text" name="RS" id="RS" value="${sellInfo.RS!''}">
                                <#else>
                                    <input class="form-control" type="text" name="RS" id="RS" placeholder="请输入0-10之间的值">
                                </#if>
                            </div>
                            <div class="col-xs-5 col-md-5">
                                <label class="control-label">%</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 col-md-6">
                            <div class="col-xs-7 col-md-7">
                                <#if  sellInfo??>
                                    <input class="form-control" type="text" id="TM"  name="TM" value="${sellInfo.TM!''}">
                                <#else>
                                    <input class="form-control" type="text" name="TM"  id="TM" placeholder="请输入0-50之间的值">
                                </#if>
                            </div>
                            <div class="col-xs-5 col-md-5">
                                <label class="control-label">%</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 col-md-6">
                            <div class="col-xs-7 col-md-7">
                                <#if  sellInfo??>
                                    <#if sellInfo.IM==0>
                                        <input class="form-control" type="text" id="TM" name="IM" value="" placeholder="请输入0-50之间的值">
                                    <#else>
                                        <input class="form-control" type="text" name="IM" value="${sellInfo.IM!''}">
                                    </#if>
                                <#else>
                                    <input class="form-control" type="text" id="TM" name="IM" placeholder="请输入0-50之间的值">
                                </#if>
                            </div>
                            <div class="col-xs-5 col-md-5">
                                <label class="control-label">%</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 col-md-6">
                            <div class="col-xs-7 col-md-7">
                                <#if  sellInfo??>
                                    <#if sellInfo.ADV != 0>
                                        <input class="form-control" type="text" name="ADV" value="${sellInfo.ADV!''}">
                                    <#else>
                                        <input class="form-control" type="text" name="ADV" placeholder="请输入0-50之间的值">
                                    </#if>
                                <#else>
                                    <input class="form-control" type="text" name="ADV" placeholder="请输入0-50之间的值">
                                </#if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 col-md-6">
                            <div class="col-xs-7 col-md-7">
                                <#if  sellInfo??>
                                    <#if sellInfo.RV != 0>
                                        <input class="form-control" type="text" name="RV" value="${sellInfo.RV!''}">
                                    <#else>
                                        <input class="form-control" type="text" name="RV" placeholder="请输入0-50之间的值">
                                    </#if>
                                <#else>
                                    <input class="form-control" type="text" name="RV" placeholder="请输入0-50之间的值">
                                </#if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 col-md-6">
                            <div class="col-xs-7 col-md-7">
                                <#if  sellInfo??>
                                    <#if sellInfo.AFT==0>
                                        <input class="form-control" type="text" name="AFT" placeholder="请输入900-1600之间的值">
                                    <#else>
                                        <input class="form-control" type="text" name="AFT" value="${sellInfo.AFT?c!''}">
                                    </#if>
                                <#else>
                                    <input class="form-control" type="text" name="AFT" placeholder="请输入900-1600之间的值">
                                </#if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 col-md-6">
                            <div class="col-xs-7 col-md-7">
                                <#if  sellInfo??>
                                    <#if sellInfo.ASH==0>
                                        <input class="form-control" type="text" name="ASH" placeholder="请输入0-50之间的值">
                                    <#else>
                                        <input class="form-control" type="text" name="ASH" value="${sellInfo.ASH!''}">
                                    </#if>
                                <#else>
                                    <input class="form-control" type="text" name="ASH" placeholder="请输入0-50之间的值">
                                </#if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 col-md-6">
                            <div class="col-xs-7 col-md-7">
                                <#if sellInfo??>
                                    <#if sellInfo.HGI==0>
                                        <input class="form-control" type="text" name="HGI" placeholder="请输入0-100之间的值">
                                    <#else>
                                        <input class="form-control" type="text" name="HGI" value="${sellInfo.HGI!''}">
                                    </#if>
                                <#else>
                                    <input class="form-control" type="text" name="HGI" placeholder="请输入0-100之间的值">
                                </#if>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10 col-md-10">
                            <div class="col-xs-4 col-md-4">
                                <select class="form-control" name="deliverymode" id="deliveryWay">
                                    <#if deliverymodes ??>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-7 col-md-7" id="way">
                            <div class="col-xs-3 col-md-3">
                                <select class="form-control" name="deliveryprovince" id="deliveryprovince">
                                    <#if provincelist ??>
                                ...
                                <#if sellInfo ??>
                                    ...
                                    <#if sellInfo.otherharbour ??>
                                        <div id="otherplaceDisplay">
                                            <input type="text" class="form-control" id="otherharbour" name="otherharbour1" maxlength="20" value="${sellInfo.otherharbour!''}">
                                        </div>
                                    </#if>
                                    </#if>
                                </#if>
                                <div id ="otherplaceDisplay" style="display: none;">
                                    <input type="text" class="form-control" id="otherharbour" name="otherharbour" maxlength="20">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10 col-md-10">
                            <div class="col-xs-4 col-md-4">
                                <select class="form-control" name="inspectorg" id="orgSelect">
                                    <#if inspectorgs??>
                                    ...
                                    <#if sellInfo.inspectorg=="其它">
                                        <#if sellInfo.otherinspectorg ??>
                                            <div id="otherorgDisplay">
                                                <input type="text" class="form-control" id="otherinspectorg" name="otherinspectorg1" maxlength="20" value="${sellInfo.otherinspectorg!''}">
                                            </div>
                                        </#if>
                                    </#if>
                                </#if>
                                <div class="input-group date" style="display: none;" id="otherorgDisplay">
                                    <input type="text" id="otherinspectorg" class="form-control" name="otherinspectorg" maxlength="20">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-10 col-md-10">
                                <#if sellInfo ??>
                                    <#if sellInfo.linktype>
                                        <input type="radio" class="linkItem" id="linktype0" name="linktype" value="0" /><label for="linktype0">&nbsp;委托XX网快速寻找买家</label>&nbsp;&nbsp;&nbsp;
                                        <input type="radio" class="linkItem" id="linktype1" name="linktype" value="1" checked="checked" /><label for="linktype1">&nbsp;让买家联系我</label>
                                    <#else>
                                        <input type="radio" class="linkItem" id="linktype0" name="linktype" value="0" checked="checked" /><label for="linktype0">&nbsp;委托XX网快速寻找买家</label>&nbsp;&nbsp;&nbsp;
                                        <input type="radio" class="linkItem" id="linktype1" name="linktype" value="1" /><label for="linktype1">&nbsp;让买家联系我</label>
                                    </#if>
                                <#else>
                                    <input type="radio" class="linkItem" id="linktype0" name="linktype" value="0" checked="checked" /><label for="linktype0">&nbsp;委托XX网快速寻找买家</label>&nbsp;&nbsp;&nbsp;
                                    <input type="radio" class="linkItem" id="linktype1" name="linktype" value="1" /><label for="linktype1">&nbsp;让买家联系我</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6 col-md-6">
                            <div class="col-xs-12 col-md-12">
                                ...
                                <#else>
                                    <textarea class="form-control" rows="4" id="releaseremarks" name="releaseremarks" placeholder="请输入对付款方式，交货方式等的说明。（选填）" maxlength="200"></textarea>
                                </#if>
                            </div>
                        </div>
                    </div>
    ...
    <div class="form-group" style="margin-top: 5%;">
        <div class="col-xs-2 col-sm-offset-2 col-md-2">
            <button type="button" id="btn-confirmSupply" class="btn btn-primary btn-block">确认发布</button>
        </div>
        <div class="col-xs-2 col-md-2">
