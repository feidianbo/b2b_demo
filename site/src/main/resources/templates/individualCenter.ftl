                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-7 col-md-7">
                                    ...
                                    <div class="row" style="margin-left: 0px; margin-right: 0px;">
                                        ...
                                        <iframe  id="picForLicense" name="form-businesslicense" src="" width="600px;" height="500px;" ></iframe>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-7 col-md-7">
                                    ...
                                    <div class="row" style="margin-left: 0px; margin-right: 0px;">
                                        ...
                                        <iframe id="picForOperate" name="form-operatinglicense" src="" width="600px" height="500px;"></iframe>
                                    </div>
                                </div>
                            </div>
