require(['jquery', 'jquery.validation', 'jquery-form'], function ($, jquery_validation) {
  ...
  $(function () {
    ...
    function setVal(obj) {
      ...
      $("#city").val(obj['city']);
      setCity(obj['province'],obj['city']);
      $("#mainvariety").val(obj['mainvariety']);
    ...
    $("#invoicinginformationClick").click(function () {
      ...
      $('#form-invoicinginformation').ajaxSubmit({
        success: function (data) {
          if (data.success) {
    ...
    $("#businesslicenseClick").click(function () {
      ...
      $('#form-businesslicense').ajaxSubmit({
        success: function (data) {
          if (data.success) {
    ...
    $("#identificationnumberClick").click(function () {
      ...
      $('#form-identificationnumber').ajaxSubmit({
        success: function (data) {
          if (data.success) {
    ...
    $("#organizationcodeClick").click(function () {
      ...
      $('#form-organizationcode').ajaxSubmit({
        success: function (data) {
          if (data.success) {
    ...
    $("#operatinglicenseClick").click(function () {
      ...
      if (operate == "") {
        ...
        $('#form-operatinglicense').ajaxSubmit({
          success: function (data) {
            if (data.success) {
    ...
    $("#openinglicenseClick").click(function () {
      ...
      if (license == "") {
        ...
        $('#form-openinglicense').ajaxSubmit({
          success: function (data) {
            if (data.success) {
    ...
    if (checkName()
      ...
      $.ajax({
        ...
        data: {
          ...
          account: $("#account").val(),
          identificationnumword: $("#identificationnumword").val(),
          zipcode: $("#zipcode").val(),
          province: $("#province").val(),
          city: $("#city").val(),
          mainvariety: $("#mainvariety").val(),
          //invoicinginformation: $("#hide-invoicinginformation").val(),
          businesslicense: $("#hide-license").val(),
          //identificationnumber: 1111,//$("#hide-number").val(),
          //organizationcode: $("#hide-code").val(),
          //openinglicense: $("#hide-openinglicense").val()
          operatinglicense: $("#hide-operating").val()
        },
        success: function (data) {
  ...
  function checkMainVariety() {
    if ($('#mainvariety').val() == "") {
      $("#mainvarietyError").text("请输入主营品种!");
      return false;
    } else {
      $("#mainvarietyError").text("");
      return true;
    }
  }
